...
Users user = (Users) o;
ValidationUtils.rejectIfEmptyOrWhitespace(errors, "fname", "NotEmpty"); //size.user.fname
ValidationUtils.rejectIfEmptyOrWhitespace(errors, "lname", "NotEmpty"); //size.user.lname
