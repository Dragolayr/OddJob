            ...
            <aside class="right-sidebar">
              ...
              <div class="widget">
                ...
                <ul class="contact-info">
                  <li><label>Address :</label> Someplace in space<br /> Borealis Tundra, Michigan</li>
                  <li><label>Phone :</label>(123)-456-7899</li>
                  <li><label>Fax : </label>(123)-455-9900</li>
                  <li><label>Email : </label>jongreenwolf@gmail.com</li>
                </ul>
